...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPACE, 
		...
		KC_LCTL, KC_LALT, KC_LCMD, KC_ENT, LT(_ALT, KC_SPC), MO(_ALT), KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  [_ALT] = LAYOUT( /* Game */
    KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRNS, 
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(_ALT), KC_BRMD, KC__VOLDOWN, KC_BRMU
  ),
  [_RESET] = LAYOUT( /* Game */
